...
public class Wall_bak extends Thing {
	...
	public Wall_bak(Vector2f shape, Vector3f origin, Quat4f quat) {
		this.type="Wall";
		this.shape=new Vector3f(shape.x,shape.y,0.3f); //shape.z - wall "thickness"
		this.origin=origin;
		this.quat=quat;
	}
	public Wall_bak setTextureType(int tt) {
		textureType=tt;
		return this;
	}
	public Wall_bak setAspect(Vector2f naspect) {
		aspect=naspect;
		return this;
	}
	public Wall_bak setTextureOffset(Vector2f nto) {
		texOffset=nto;
		return this;
	}
	public Wall_bak setSideMode(int in) {
		sided=in;
		return this;
	}
